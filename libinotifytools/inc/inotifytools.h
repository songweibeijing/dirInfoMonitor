...
#include <stdio.h>
    ...
    void inotifytools_remove_filename_prefix(char const *filename);
    ...
    // [UH]
    //added by msong
    int inotifytools_watch_recursively_with_level(char const *path, int events, int level, char **excludedir);
    int inotifytools_watch_recursively_level(char const *path, int events, int level, char **excludedir);
    //end
